...
public:
  ...
  : cpp_mock_scenarios::CppScenarioNode(
      "lanechange_left", /* ament_index_cpp::get_package_share_directory("kashiwanoha_map") + "/map"
                          */
      "/home/dmoszynski/robotecai/autoware/sources/autoware_maps/odaiba_beta", "lanelet2_map.osm",
...
private:
  ...
  // Set color for the traffic_right_id. Set opposite color (green <-> red) to the
  // opposite_traffic_right_id
  ...
  void onUpdate() override
  {
    ...
    spawnAndMoveToGoal(1482, 1499, 15.0, 15.0);
    spawnAndMoveToGoal(1483, 1500, 15.0, 15.0);
    spawnAndMoveToGoal(1484, 1501, 15.0, 15.0);
    ...
    updateRandomTrafficLightColor(
      {10324, 190343}, {10316, 10322}, tl_state_manager_.getCurrentState());
    updateRandomTrafficLightColor({10352}, {10356, 10359}, tl_state_manager_.getCurrentState());
    // updateRandomTrafficLightColor({179285, 10284}, {10293, 10283},
    // tl_state_manager_.getCurrentState());
    updateRandomTrafficLightColor(
      {10269, 10276}, {10263, 10277}, tl_state_manager_.getCurrentState());
    ...
    updateRandomTrafficLightColor(
      {10575, 10569}, {10571, 10581}, tl_state_manager_.getCurrentState());
